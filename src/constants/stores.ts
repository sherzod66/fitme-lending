...
/**
 * Plain brand glyphs, the same paths the project has always shipped. No
 * official store badge artwork exists in the repo, so none is faked.
 */
export const STORES: Record<StorePlatform, { href: string; labelKey: string; glyph: string }> = {
	ios: {
		href: ios_link,
